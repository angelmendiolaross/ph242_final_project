...
run.tmle <- function(df_short, SL.library, id=NULL){
  ...
  gHatSL <- SuperLearner(Y=df_short$A, X=X, SL.library=SL.library, family="gaussian", id=NULL)
  ...
  #------------------------------------------
  logitUpdate<- glm(df_short$infection_rate_bin ~ -1 + offset(qlogis(QbarAW)) + H.AW, family='gaussian')
